...
import { myBookingsStyles as s } from "../../../public/assets/dummyStyles";
...
const MyBookings = () => {
  ...
  const fetchBookings = useCallback(async () => {
    ...
    try {
      ...
      const normalized = (Array.isArray(localBookings) ? localBookings : []).map(
        normalizeBooking
      );
      ...
      setError(
        "Showing your locally saved demo bookings because the live booking service is unavailable."
      );
      setLoading(false);
    } finally {
