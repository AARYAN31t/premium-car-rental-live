...
import { homeCarsStyles as styles } from "../../../public/assets/dummyStyles";
...
const HomeCars = () => {
  ...
  const fetchCars = async () => {
    ...
    try {
      ...
      const loadedCars = Array.isArray(res.data?.data)
        ? res.data.data
      ...
      if (!isCanceled) {
        ...
        setCars(carsData);
        setError("Showing featured cars from the local demo catalog.");
      }
    } finally {
      setLoading(false);
    }
